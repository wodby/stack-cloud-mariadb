# Cloud MariaDB application stack for Kubernetes on Wodby

Deploy Cloud MariaDB applications on Kubernetes with Wodby.

This repository defines the Wodby stack manifests and default service
composition for Cloud MariaDB.

<!-- wodby:generated:start -->

## Stack contract

- [Cloud MariaDB stack on Wodby](https://wodby.com/stacks/cloud-mariadb)
...
| --- | --- |
| Cloud MariaDB<br>`mariadb` | optional; enabled by default |
