# Cloud MariaDB stack for Wodby

Deploy Cloud MariaDB on Kubernetes with Wodby. This repository contains the
stack manifests used by the public Cloud MariaDB stack in the Wodby catalog.

- [Cloud MariaDB stack in the Wodby catalog](https://wodby.com/stacks/cloud-mariadb)
...
| --- | --- |
| Cloud MariaDB (`mariadb`)<br>`cloud-mariadb` | optional; enabled by default |
